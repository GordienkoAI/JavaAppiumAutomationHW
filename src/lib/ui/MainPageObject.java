...
public class MainPageObject {
    ...
    public WebElement inputSearchText(String Keys)
    {
    ...
    public List<WebElement> waitForListElements(By by, String error_message, long timeoutInSeconds)
    {
    ...
    public void swipeUpToFindeElement(By by, String error_messgae, int max_swipes)
    {
    ...
    public String waitElementAndGetAttribute(By by, String attribute, String error_message, long timeoutInSecond)
    {
